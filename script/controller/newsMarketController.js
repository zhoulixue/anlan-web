angular.module('rootApp.newsMarket',[
])
.config(function($routeProvider){
	 $routeProvider
        .when('/newsMarket', {
            templateUrl: 'views/newsMarket.html',
            controller: 'newsMarketController'
        })
})
.controller('newsMarketController',function ($scope,$http,$location) {
    ...
    $scope.jumpContent = function(item){
    	$location.url('/newsMarketContent?id=' + item.id);
    }
})